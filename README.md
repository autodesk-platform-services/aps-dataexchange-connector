...
# Thumbnail
![ThumbnailUI](https://github.com/autodesk-platform-services/DataExchange-sample-connector/assets/143052260/ca464e8e-6d24-4022-a7e7-d8262d1ca96c)
...
3. Restore the Data Exchange SDK packages by one of the following approaches:
    ...
    * Building the solution using *BuildSolution.bat* [Note:Prior to executing "BuildSolution.bat," either add the path of msbuild.exe to the environment variables or utilize the developer command prompt.]
